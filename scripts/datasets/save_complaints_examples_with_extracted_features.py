...
from continual_learning.dataset.continual.complaints import get_complaints_dataset
...
DATASET_NAME = 'complaints_distilbert_1536'
...
if __name__ == '__main__':
    ...
    for subset_name in ['train', 'test']:
        ...
        dataset = get_complaints_dataset(
            subset=subset_name,
